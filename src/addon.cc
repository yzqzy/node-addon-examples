...
class ExampleAddon : public Napi::Addon<ExampleAddon> {
 public:
  ExampleAddon(Napi::Env env, Napi::Object exports) {
    ...
    DefineAddon(exports,
                {InstanceMethod("hello", &ExampleAddon::Hello), InstanceMethod("increment", &ExampleAddon::Increment),
                 ...
                 InstanceValue(
                     "subObject",
                     DefineProperties(Napi::Object::New(env), {InstanceMethod("increment", &ExampleAddon::Increment),
                                                               InstanceMethod("decrement", &ExampleAddon::Decrement)}),
                     napi_enumerable)});
  }
